...
const SocialLoginButtons = () => {
    return (
        <div className='flex justify-center items-center gap-2'>
            ...
            <div className='w-[135px] h-[35px] flex justify-center items-center rounded-md bg-blue-600 shadow-lg hover:shadow-orange-700/50 hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer '>
