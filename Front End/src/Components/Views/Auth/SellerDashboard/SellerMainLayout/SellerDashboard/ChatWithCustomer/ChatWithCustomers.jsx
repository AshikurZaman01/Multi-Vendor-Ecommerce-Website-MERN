...
import MainContent from "./Chat/MainContent/MainContent";
...
const ChatWithCustomers = () => {
    ...
    return (
        <div className="h-screen w-full rounded bg-gradient-to-r from-blue-700 via-purple-600 to-pink-600 p-4">
